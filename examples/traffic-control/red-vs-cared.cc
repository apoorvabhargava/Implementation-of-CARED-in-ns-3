 ...
 *          Mansi Bhatt <mansibhatt94@gmail.com>
...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("queueDiscType", "Set Queue disc type to RED or CARED", queueDiscType);
  ...
  if ((queueDiscType != "RED") && (queueDiscType != "CARED"))
    {
      std::cout << "Invalid queue disc type: Use --queueDiscType=RED or --queueDiscType=CARED" << std::endl;
      exit (1);
    }
 ...
 Config::SetDefault ("ns3::QueueBase::Mode", StringValue ("QUEUE_MODE_PACKETS"));
  ...
  if (queueDiscType == "CARED")
    {
      // Turn on CARED
      Config::SetDefault ("ns3::RedQueueDisc::CARED", BooleanValue (true));
