 ...
 *
 * Authors: Bhaskar Gautam <bhaskar.gautam2494@gmail.com>
...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("queueDiscType", "Set Queue disc type to ARED or CARED", queueDiscType);
